...
<form name="factivitylistsrch" id="factivitylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<form name="factivitylist" id="factivitylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->activity_id->Visible) { // activity_id ?>
        <th data-name="activity_id" class="<?= $Page->activity_id->headerCellClass() ?>"><div id="elh_activity_activity_id" class="activity_activity_id"><?= $Page->renderSort($Page->activity_id) ?></div></th>
<?php } ?>
<?php if ($Page->activity_type_id->Visible) { // activity_type_id ?>
        <th data-name="activity_type_id" class="<?= $Page->activity_type_id->headerCellClass() ?>"><div id="elh_activity_activity_type_id" class="activity_activity_type_id"><?= $Page->renderSort($Page->activity_type_id) ?></div></th>
<?php } ?>
<?php if ($Page->process_id->Visible) { // process_id ?>
        <th data-name="process_id" class="<?= $Page->process_id->headerCellClass() ?>"><div id="elh_activity_process_id" class="activity_process_id"><?= $Page->renderSort($Page->process_id) ?></div></th>
<?php } ?>
<?php if ($Page->name->Visible) { // name ?>
        <th data-name="name" class="<?= $Page->name->headerCellClass() ?>"><div id="elh_activity_name" class="activity_name"><?= $Page->renderSort($Page->name) ?></div></th>
<?php } ?>
<?php if ($Page->description->Visible) { // description ?>
        <th data-name="description" class="<?= $Page->description->headerCellClass() ?>"><div id="elh_activity_description" class="activity_description"><?= $Page->renderSort($Page->description) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_activity_activity_id">
...
<span id="el<?= $Page->RowCount ?>_activity_activity_type_id">
...
<span id="el<?= $Page->RowCount ?>_activity_process_id">
...
<span id="el<?= $Page->RowCount ?>_activity_name">
...
<span id="el<?= $Page->RowCount ?>_activity_description">
