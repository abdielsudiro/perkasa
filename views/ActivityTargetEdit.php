...
// Page object
$ActivityTargetEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var factivity_targetedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    factivity_targetedit = currentForm = new ew.Form("factivity_targetedit", "edit");
    ...
    factivity_targetedit.addFields([
    ...
    // Validate form
    factivity_targetedit.validate = function () {
    ...
    // Form_CustomValidate
    factivity_targetedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    factivity_targetedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("factivity_targetedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="factivity_targetedit" id="factivity_targetedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="activity_target" data-field="x_activity_target_id" data-hidden="1" name="o_activity_target_id" id="o_activity_target_id" value="<?= HtmlEncode($Page->activity_target_id->OldValue ?? $Page->activity_target_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
