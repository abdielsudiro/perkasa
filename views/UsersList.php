...
<?php if ($Page->nama_lengkap->Visible) { // nama_lengkap ?>
        <th data-name="nama_lengkap" class="<?= $Page->nama_lengkap->headerCellClass() ?>"><div id="elh_users_nama_lengkap" class="users_nama_lengkap"><?= $Page->renderSort($Page->nama_lengkap) ?></div></th>
<?php } ?>
<?php if ($Page->satker->Visible) { // satker ?>
        <th data-name="satker" class="<?= $Page->satker->headerCellClass() ?>"><div id="elh_users_satker" class="users_satker"><?= $Page->renderSort($Page->satker) ?></div></th>
<?php } ?>
<?php if ($Page->nip->Visible) { // nip ?>
        <th data-name="nip" class="<?= $Page->nip->headerCellClass() ?>"><div id="elh_users_nip" class="users_nip"><?= $Page->renderSort($Page->nip) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_users_nama_lengkap">
...
<span id="el<?= $Page->RowCount ?>_users_satker">
...
<span id="el<?= $Page->RowCount ?>_users_nip">
