...
// Page object
$RabKegiatan2Add = &$Page;
?>
<script>
var currentForm, currentPageID;
var frab_kegiatan2add;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    frab_kegiatan2add = currentForm = new ew.Form("frab_kegiatan2add", "add");
    ...
    // Validate form
    frab_kegiatan2add.validate = function () {
    ...
    // Form_CustomValidate
    frab_kegiatan2add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frab_kegiatan2add.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frab_kegiatan2add.lists.satker_id = <?= $Page->satker_id->toClientList($Page) ?>;
    frab_kegiatan2add.lists.kode_kegiatan = <?= $Page->kode_kegiatan->toClientList($Page) ?>;
    frab_kegiatan2add.lists.kode_kro = <?= $Page->kode_kro->toClientList($Page) ?>;
    frab_kegiatan2add.lists.kode_ro = <?= $Page->kode_ro->toClientList($Page) ?>;
    frab_kegiatan2add.lists.kode_komponen = <?= $Page->kode_komponen->toClientList($Page) ?>;
    frab_kegiatan2add.lists.kode_subkomponen = <?= $Page->kode_subkomponen->toClientList($Page) ?>;
    frab_kegiatan2add.lists.reviewer_note_id = <?= $Page->reviewer_note_id->toClientList($Page) ?>;
    frab_kegiatan2add.lists.approval_note_id = <?= $Page->approval_note_id->toClientList($Page) ?>;
    loadjs.done("frab_kegiatan2add");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frab_kegiatan2add" id="frab_kegiatan2add" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
