...
// Page object
$RabNotePenelaahEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var frab_note_penelaahedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    frab_note_penelaahedit = currentForm = new ew.Form("frab_note_penelaahedit", "edit");
    ...
    // Validate form
    frab_note_penelaahedit.validate = function () {
    ...
    // Form_CustomValidate
    frab_note_penelaahedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frab_note_penelaahedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frab_note_penelaahedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frab_note_penelaahedit" id="frab_note_penelaahedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="rab_note_penelaah" data-field="x_id_rab_note_penelaah" data-hidden="1" name="x_id_rab_note_penelaah" id="x_id_rab_note_penelaah" value="<?= HtmlEncode($Page->id_rab_note_penelaah->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
