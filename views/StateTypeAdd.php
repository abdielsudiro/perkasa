...
loadjs.ready("head", function () {
    ...
    fstate_typeadd = currentForm = new ew.Form("fstate_typeadd", "add");
    ...
    // Validate form
    fstate_typeadd.validate = function () {
    ...
    // Form_CustomValidate
    fstate_typeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstate_typeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fstate_typeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fstate_typeadd" id="fstate_typeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
