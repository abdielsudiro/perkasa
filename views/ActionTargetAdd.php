...
// Page object
$ActionTargetAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var faction_targetadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    faction_targetadd = currentForm = new ew.Form("faction_targetadd", "add");
    ...
    // Validate form
    faction_targetadd.validate = function () {
    ...
    // Form_CustomValidate
    faction_targetadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    faction_targetadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("faction_targetadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="faction_targetadd" id="faction_targetadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
