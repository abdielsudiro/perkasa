...
loadjs.ready("head", function () {
    ...
    frequest2edit = currentForm = new ew.Form("frequest2edit", "edit");
    ...
    // Validate form
    frequest2edit.validate = function () {
    ...
    frequest2edit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frequest2edit.lists._username = <?= $Page->_username->toClientList($Page) ?>;
...
<input type="hidden" data-table="request2" data-field="x_request_id" data-hidden="1" name="o_request_id" id="o_request_id" value="<?= HtmlEncode($Page->request_id->OldValue ?? $Page->request_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php
    if (in_array("request_rab", explode(",", $Page->getCurrentDetailTable())) && $request_rab->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("request_note", explode(",", $Page->getCurrentDetailTable())) && $request_note->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("request_stakeholder", explode(",", $Page->getCurrentDetailTable())) && $request_stakeholder->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("request_action", explode(",", $Page->getCurrentDetailTable())) && $request_action->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("request_data", explode(",", $Page->getCurrentDetailTable())) && $request_data->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("process", explode(",", $Page->getCurrentDetailTable())) && $process->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("request_file", explode(",", $Page->getCurrentDetailTable())) && $request_file->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
