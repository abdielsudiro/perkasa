...
loadjs.ready("head", function () {
    ...
    fsatkeradd = currentForm = new ew.Form("fsatkeradd", "add");
    ...
    // Form_CustomValidate
    fsatkeradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsatkeradd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fsatkeradd.lists.unit_org_id = <?= $Page->unit_org_id->toClientList($Page) ?>;
    loadjs.done("fsatkeradd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsatkeradd" id="fsatkeradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
