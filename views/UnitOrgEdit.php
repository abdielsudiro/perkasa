...
loadjs.ready("head", function () {
    ...
    funit_orgedit = currentForm = new ew.Form("funit_orgedit", "edit");
    ...
    // Validate form
    funit_orgedit.validate = function () {
    ...
    // Form_CustomValidate
    funit_orgedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    funit_orgedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("funit_orgedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="funit_orgedit" id="funit_orgedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="unit_org" data-field="x_unit_org_id" data-hidden="1" name="o_unit_org_id" id="o_unit_org_id" value="<?= HtmlEncode($Page->unit_org_id->OldValue ?? $Page->unit_org_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
