...
loadjs.ready("head", function () {
    ...
    frab_noteadd = currentForm = new ew.Form("frab_noteadd", "add");
    ...
    // Validate form
    frab_noteadd.validate = function () {
    ...
    // Form_CustomValidate
    frab_noteadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frab_noteadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frab_noteadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frab_noteadd" id="frab_noteadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
