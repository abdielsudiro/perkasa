...
// Page object
$RequestDataEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var frequest_dataedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    frequest_dataedit = currentForm = new ew.Form("frequest_dataedit", "edit");
    ...
    // Validate form
    frequest_dataedit.validate = function () {
    ...
    // Form_CustomValidate
    frequest_dataedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frequest_dataedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frequest_dataedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frequest_dataedit" id="frequest_dataedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="request_data" data-field="x_request_data_id" data-hidden="1" name="o_request_data_id" id="o_request_data_id" value="<?= HtmlEncode($Page->request_data_id->OldValue ?? $Page->request_data_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
