...
loadjs.ready("head", function () {
    ...
    fsubkomponenadd = currentForm = new ew.Form("fsubkomponenadd", "add");
    ...
    // Validate form
    fsubkomponenadd.validate = function () {
    ...
    // Form_CustomValidate
    fsubkomponenadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsubkomponenadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fsubkomponenadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fsubkomponenadd" id="fsubkomponenadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
