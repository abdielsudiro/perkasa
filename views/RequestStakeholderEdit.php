...
// Page object
$RequestStakeholderEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var frequest_stakeholderedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    frequest_stakeholderedit = currentForm = new ew.Form("frequest_stakeholderedit", "edit");
    ...
    frequest_stakeholderedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = frequest_stakeholderedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    frequest_stakeholderedit.validate = function () {
    ...
    // Form_CustomValidate
    frequest_stakeholderedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frequest_stakeholderedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frequest_stakeholderedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frequest_stakeholderedit" id="frequest_stakeholderedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
<input type="hidden" data-table="request_stakeholder" data-field="x_request_id" data-hidden="1" name="o_request_id" id="o_request_id" value="<?= HtmlEncode($Page->request_id->OldValue ?? $Page->request_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
