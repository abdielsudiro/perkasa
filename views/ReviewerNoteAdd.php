...
// Page object
$ReviewerNoteAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var freviewer_noteadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    freviewer_noteadd = currentForm = new ew.Form("freviewer_noteadd", "add");
    ...
    // Validate form
    freviewer_noteadd.validate = function () {
    ...
    // Form_CustomValidate
    freviewer_noteadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    freviewer_noteadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("freviewer_noteadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="freviewer_noteadd" id="freviewer_noteadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
