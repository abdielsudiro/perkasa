...
loadjs.ready("head", function () {
    ...
    frequest_rabadd = currentForm = new ew.Form("frequest_rabadd", "add");
    ...
    // Validate form
    frequest_rabadd.validate = function () {
    ...
    // Form_CustomValidate
    frequest_rabadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frequest_rabadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frequest_rabadd.lists.id_rab = <?= $Page->id_rab->toClientList($Page) ?>;
    loadjs.done("frequest_rabadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frequest_rabadd" id="frequest_rabadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
