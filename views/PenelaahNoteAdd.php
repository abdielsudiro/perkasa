...
// Page object
$PenelaahNoteAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenelaah_noteadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpenelaah_noteadd = currentForm = new ew.Form("fpenelaah_noteadd", "add");
    ...
    // Validate form
    fpenelaah_noteadd.validate = function () {
    ...
    // Form_CustomValidate
    fpenelaah_noteadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenelaah_noteadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpenelaah_noteadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenelaah_noteadd" id="fpenelaah_noteadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
