...
var frab_rincianedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    frab_rincianedit = currentForm = new ew.Form("frab_rincianedit", "edit");
    ...
    // Validate form
    frab_rincianedit.validate = function () {
    ...
    // Form_CustomValidate
    frab_rincianedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frab_rincianedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frab_rincianedit.lists.kode_akun = <?= $Page->kode_akun->toClientList($Page) ?>;
    loadjs.done("frab_rincianedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frab_rincianedit" id="frab_rincianedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="rab_rincian" data-field="x_rab_rincian_id" data-hidden="1" name="x_rab_rincian_id" id="x_rab_rincian_id" value="<?= HtmlEncode($Page->rab_rincian_id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
