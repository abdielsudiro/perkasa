 ...
 * Page class
 */
class Action2Add extends Action2
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "Action2View") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // action_id
        $this->action_id->setDbValueDef($rsnew, $this->action_id->CurrentValue, 0, false);

        // action_type_id
        $this->action_type_id->setDbValueDef($rsnew, $this->action_type_id->CurrentValue, null, false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['action_id']) == "") {
