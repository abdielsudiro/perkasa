 ...
 * Page class
 */
class RabRincianView extends RabRincian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabRincianView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("rab_rincian_id") ?? Route("rab_rincian_id")) !== null) {
            $this->RecKey["rab_rincian_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("rab_rincian_id") ?? Route("rab_rincian_id")) !== null) {
                ...
                $this->RecKey["rab_rincian_id"] = $this->rab_rincian_id->QueryStringValue;
            } elseif (Post("rab_rincian_id") !== null) {
                $this->rab_rincian_id->setFormValue(Post("rab_rincian_id"));
                $this->RecKey["rab_rincian_id"] = $this->rab_rincian_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->rab_rincian_id->setQueryStringValue($keyValue);
                $this->RecKey["rab_rincian_id"] = $this->rab_rincian_id->QueryStringValue;
            } else {
                $returnUrl = "RabRincianList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RabRincianList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RabRincianList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
