 ...
 * Page class
 */
class RequestActionList extends RequestAction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestActionList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "frequest_actionlist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "RequestActionDelete";
        $this->MultiUpdateUrl = "RequestActionUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option frequest_actionlistsrch";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->request_action_id); // request_action_id
            ...
            $this->updateSort($this->is_complete); // is_complete
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->request_action_id->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"frequest_actionlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"frequest_actionlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.frequest_actionlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
