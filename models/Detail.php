...
/**
 * Table class for detail
 */
class Detail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'detail';
        $this->TableName = 'detail';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`detail`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // detail_id
        $this->detail_id = new DbField('detail', 'detail', 'x_detail_id', 'detail_id', '`detail_id`', '`detail_id`', 3, 11, -1, false, '`detail_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kode_akun
        $this->kode_akun = new DbField('detail', 'detail', 'x_kode_akun', 'kode_akun', '`kode_akun`', '`kode_akun`', 200, 20, -1, false, '`kode_akun`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // detail
        $this->detail = new DbField('detail', 'detail', 'x_detail', 'detail', '`detail`', '`detail`', 201, 65535, -1, false, '`detail`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // volum
        $this->volum = new DbField('detail', 'detail', 'x_volum', 'volum', '`volum`', '`volum`', 131, 10, -1, false, '`volum`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sbm
        $this->sbm = new DbField('detail', 'detail', 'x_sbm', 'sbm', '`sbm`', '`sbm`', 5, 10, -1, false, '`sbm`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`detail`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DetailList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "DetailEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DetailAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DetailView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DetailView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DetailAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DetailAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DetailEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetailAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DetailDelete", $this->getUrlParm());
    }
