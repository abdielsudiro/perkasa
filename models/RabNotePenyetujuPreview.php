 ...
 * Page class
 */
class RabNotePenyetujuPreview extends RabNotePenyetuju
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabNotePenyetujuPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        $url = "";
        if ($masterTblVar == "rab") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=rab&" . GetForeignKeyUrl("fk_id_rab", $this->id_rab->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "rab") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_rab->setQueryStringValue($val);
            }
        }
    }
