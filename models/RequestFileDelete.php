 ...
 * Page class
 */
class RequestFileDelete extends RequestFile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestFileDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RequestFileList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RequestFileList"); // Return to list
                return;
            }
        }
