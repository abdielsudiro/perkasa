...
/**
 * Table class for v_akun
 */
class VAkun extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_akun';
        $this->TableName = 'v_akun';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_akun`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Kode
        $this->Kode = new DbField('v_akun', 'v_akun', 'x_Kode', 'Kode', '`Kode`', '`Kode`', 200, 120, -1, false, '`Kode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Uraian
        $this->Uraian = new DbField('v_akun', 'v_akun', 'x_Uraian', 'Uraian', '`Uraian`', '`Uraian`', 200, 255, -1, false, '`Uraian`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_akun`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VAkunList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VAkunView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VAkunEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VAkunAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VAkunView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VAkunView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VAkunAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VAkunAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VAkunEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VAkunAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VAkunDelete", $this->getUrlParm());
    }
