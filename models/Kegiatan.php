...
class Kegiatan extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // kode_kegiatan
        $this->kode_kegiatan = new DbField('kegiatan', 'kegiatan', 'x_kode_kegiatan', 'kode_kegiatan', '`kode_kegiatan`', '`kode_kegiatan`', 200, 20, -1, false, '`kode_kegiatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kode_program
        $this->kode_program = new DbField('kegiatan', 'kegiatan', 'x_kode_program', 'kode_program', '`kode_program`', '`kode_program`', 200, 20, -1, false, '`kode_program`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->kode_program->Lookup = new Lookup('kode_program', 'program', false, 'kode_program', ["kode_program","","",""], [], [], [], [], [], [], '', '');
        ...
        // nama_kegiatan
        $this->nama_kegiatan = new DbField('kegiatan', 'kegiatan', 'x_nama_kegiatan', 'nama_kegiatan', '`nama_kegiatan`', '`nama_kegiatan`', 200, 120, -1, false, '`nama_kegiatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nama_kegiatan->Sortable = true; // Allow sort
        $this->nama_kegiatan->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->nama_kegiatan->Param, "CustomMsg");
        $this->Fields['nama_kegiatan'] = &$this->nama_kegiatan;

        // id
        $this->id = new DbField('kegiatan', 'kegiatan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
