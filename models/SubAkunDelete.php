 ...
 * Page class
 */
class SubAkunDelete extends SubAkun
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubAkunDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SubAkunList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SubAkunList"); // Return to list
                return;
            }
        }
