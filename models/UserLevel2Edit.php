 ...
 * Page class
 */
class UserLevel2Edit extends UserLevel2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevel2Edit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // user_level_name
            $this->user_level_name->setDbValueDef($rsnew, $this->user_level_name->CurrentValue, null, $this->user_level_name->ReadOnly);
