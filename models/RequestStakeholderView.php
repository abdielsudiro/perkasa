 ...
 * Page class
 */
class RequestStakeholderView extends RequestStakeholder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestStakeholderView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
                ...
                $returnUrl = "RequestStakeholderList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RequestStakeholderList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RequestStakeholderList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
