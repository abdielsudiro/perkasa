 ...
 * Page class
 */
class RequestStakeholderDelete extends RequestStakeholder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestStakeholderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RequestStakeholderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RequestStakeholderList"); // Return to list
                return;
            }
        }
