 ...
 * Page class
 */
class ProcessGrid extends Process
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fprocessgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->process_id->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_process_id") && $CurrentForm->hasValue("o_process_id") && $this->process_id->CurrentValue != $this->process_id->OldValue) {
            return false;
        }
    ...
    {
        $this->process_id->clearErrorMessage();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "request2") {
            $this->process_id->CurrentValue = $this->process_id->getSessionValue();
        }
        $conn = $this->getConnection();
