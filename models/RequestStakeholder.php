...
/**
 * Table class for request_stakeholder
 */
class RequestStakeholder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'request_stakeholder';
        $this->TableName = 'request_stakeholder';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`request_stakeholder`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // request_id
        $this->request_id = new DbField('request_stakeholder', 'request_stakeholder', 'x_request_id', 'request_id', '`request_id`', '`request_id`', 3, 11, -1, false, '`request_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user_id
        $this->user_id = new DbField('request_stakeholder', 'request_stakeholder', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, 11, -1, false, '`user_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`request_stakeholder`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RequestStakeholderList");
    }
    ...
    {
        global $Language;
        if ($pageName == "RequestStakeholderView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RequestStakeholderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RequestStakeholderAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "RequestStakeholderView";
            case Config("API_ADD_ACTION"):
                return "RequestStakeholderAdd";
            case Config("API_EDIT_ACTION"):
                return "RequestStakeholderEdit";
            case Config("API_DELETE_ACTION"):
                return "RequestStakeholderDelete";
            case Config("API_LIST_ACTION"):
                return "RequestStakeholderList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RequestStakeholderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RequestStakeholderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RequestStakeholderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RequestStakeholderAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RequestStakeholderEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RequestStakeholderAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RequestStakeholderDelete", $this->getUrlParm());
    }
