 ...
 * Page class
 */
class UserLevelPermissionAdd extends UserLevelPermission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevelPermissionAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UserLevelPermissionView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // permission
        $this->_permission->setDbValueDef($rsnew, $this->_permission->CurrentValue, null, false);
