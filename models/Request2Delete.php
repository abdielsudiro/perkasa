 ...
 * Page class
 */
class Request2Delete extends Request2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Request2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Request2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Request2List"); // Return to list
                return;
            }
        }
