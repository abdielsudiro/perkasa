...
class KroEdit extends Kro
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // kode_kro
            $this->kode_kro->setDbValueDef($rsnew, $this->kode_kro->CurrentValue, "", $this->kode_kro->ReadOnly);

            // kode_kegiatan
            $this->kode_kegiatan->setDbValueDef($rsnew, $this->kode_kegiatan->CurrentValue, null, $this->kode_kegiatan->ReadOnly);

            // nama_kro
            $this->nama_kro->setDbValueDef($rsnew, $this->nama_kro->CurrentValue, null, $this->nama_kro->ReadOnly);
