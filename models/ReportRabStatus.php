...
/**
 * Table class for Report RAB Status
 */
class ReportRabStatus extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ReportRABStatus';
        $this->TableName = 'Report RAB Status';
        $this->TableType = 'REPORT';

        // Update Table
        $this->UpdateTable = "`v_rab_status`";
        $this->ReportSourceTable = 'v_rab_status'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nama_satker
        $this->nama_satker = new ReportField('ReportRABStatus', 'Report RAB Status', 'x_nama_satker', 'nama_satker', '`nama_satker`', '`nama_satker`', 200, 70, -1, false, '`nama_satker`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->nama_satker->SourceTableVar = 'v_rab_status';
        $this->Fields['nama_satker'] = &$this->nama_satker;

        // subtotal
        $this->subtotal = new ReportField('ReportRABStatus', 'Report RAB Status', 'x_subtotal', 'subtotal', '`subtotal`', '`subtotal`', 131, 15, -1, false, '`subtotal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->subtotal->GroupingFieldId = 2;
        $this->subtotal->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->subtotal->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->subtotal->GroupByType = "";
        $this->subtotal->GroupInterval = "0";
        $this->subtotal->GroupSql = "";
        ...
        $this->subtotal->SourceTableVar = 'v_rab_status';
        $this->Fields['subtotal'] = &$this->subtotal;

        // id_statuses
        $this->id_statuses = new ReportField('ReportRABStatus', 'Report RAB Status', 'x_id_statuses', 'id_statuses', '`id_statuses`', '`id_statuses`', 3, 11, -1, false, '`id_statuses`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->id_statuses->GroupingFieldId = 1;
        $this->id_statuses->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->id_statuses->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->id_statuses->GroupByType = "";
        $this->id_statuses->GroupInterval = "0";
        $this->id_statuses->GroupSql = "";
        ...
        $this->id_statuses->SourceTableVar = 'v_rab_status';
        $this->Fields['id_statuses'] = &$this->id_statuses;

        // ChartRABStatus
        $this->ChartRABStatus = new DbChart($this, 'ChartRABStatus', 'ChartRABStatus', 'id_statuses', 'subtotal', 1001, '', 0, 'SUM', 550, 440);
        $this->ChartRABStatus->SortType = 0;
        $this->ChartRABStatus->SortSequence = "";
        $this->ChartRABStatus->SqlSelect = $this->getQueryBuilder()->select("`id_statuses`", "''", "SUM(`subtotal`)");
        $this->ChartRABStatus->SqlGroupBy = "`id_statuses`";
        $this->ChartRABStatus->SqlOrderBy = "";
        $this->ChartRABStatus->SeriesDateType = "";
        $this->ChartRABStatus->ID = "ReportRABStatus_ChartRABStatus"; // Chart ID
        $this->ChartRABStatus->setParameters([
            ["type", "1001"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->ChartRABStatus->setParameters([
            ["caption", $this->ChartRABStatus->caption()],
            ["xaxisname", $this->ChartRABStatus->xAxisName()]
        ]); // Chart caption / X axis name
        $this->ChartRABStatus->setParameter("yaxisname", $this->ChartRABStatus->yAxisName()); // Y axis name
        $this->ChartRABStatus->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->ChartRABStatus->setParameter("alpha", "50"); // Chart alpha
        $this->ChartRABStatus->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
        $this->ChartRABStatus->setParameters([["options.legend.display",false],["options.legend.fullWidth",false],["options.legend.reverse",false],["options.legend.labels.usePointStyle",false],["options.title.display",false],["options.tooltips.enabled",false],["options.tooltips.intersect",false],["options.tooltips.displayColors",false],["options.plugins.filler.propagate",false],["options.animation.animateRotate",false],["options.animation.animateScale",false],["dataset.showLine",false],["dataset.spanGaps",false],["dataset.steppedLine",false],["scale.gridLines.offsetGridLines",false],["annotation1.show",false],["annotation1.secondaryYAxis",false],["annotation2.show",false],["annotation2.secondaryYAxis",false],["annotation3.show",false],["annotation3.secondaryYAxis",false],["annotation4.show",false],["annotation4.secondaryYAxis",false]]);
    }
    ...
    public function getSqlFirstGroupField($alias = false)
    {
        ...
        $firstGroupField = &$this->id_statuses;
