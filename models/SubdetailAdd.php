 ...
 * Page class
 */
class SubdetailAdd extends Subdetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubdetailAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "SubdetailView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->subdetail_id->OldValue = $this->subdetail_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['subdetail_id'] = $this->subdetail_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // subdetail_id
        $this->subdetail_id->setDbValueDef($rsnew, $this->subdetail_id->CurrentValue, 0, false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['subdetail_id']) == "") {
