...
class AkunEdit extends Akun
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // uraian
            $this->uraian->setDbValueDef($rsnew, $this->uraian->CurrentValue, "", $this->uraian->ReadOnly);
            ...
            $this->isSubAccount->setDbValueDef($rsnew, $tmpBool, null, $this->isSubAccount->ReadOnly);
