...
class KroDelete extends Kro
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KroList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KroList"); // Return to list
                return;
            }
        }
