 ...
 * Page class
 */
class RabRincianDelete extends RabRincian
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabRincianDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RabRincianList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RabRincianList"); // Return to list
                return;
            }
        }
