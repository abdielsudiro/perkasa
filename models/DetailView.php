 ...
 * Page class
 */
class DetailView extends Detail
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("detail_id") ?? Route("detail_id")) !== null) {
                ...
                $returnUrl = "DetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DetailList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
