 ...
 * Page class
 */
class RequestActionDelete extends RequestAction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestActionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RequestActionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RequestActionList"); // Return to list
                return;
            }
        }
