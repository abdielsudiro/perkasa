 ...
 * Page class
 */
class SubAkunView extends SubAkun
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubAkunView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("detail_id") ?? Route("detail_id")) !== null) {
            $this->RecKey["detail_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("detail_id") ?? Route("detail_id")) !== null) {
                ...
                $returnUrl = "SubAkunList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SubAkunList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "SubAkunList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
