 ...
 * Page class
 */
class UserLevel2Delete extends UserLevel2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevel2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserLevel2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UserLevel2List"); // Return to list
                return;
            }
        }
