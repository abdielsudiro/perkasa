 ...
 * Page class
 */
class RabFileGrid extends RabFile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabFileGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "frab_filegrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_rab_file->CurrentValue;
    ...
    {
        global $CurrentForm;
        if (!EmptyValue($this->filename->Upload->Value)) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->filename->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->filename->Upload->Index = $this->RowIndex;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_rab_file->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (is_numeric($this->RowIndex)) {
                RenderUploadField($this->filename, $this->RowIndex);
            }
