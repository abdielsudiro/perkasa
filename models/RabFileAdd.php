 ...
 * Page class
 */
class RabFileAdd extends RabFile
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RabFileView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_rab_file->OldValue = $this->id_rab_file->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_rab_file'] = $this->id_rab_file->CurrentValue;
