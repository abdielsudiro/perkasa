...
/**
 * Table class for transition_action
 */
class TransitionAction extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'transition_action';
        $this->TableName = 'transition_action';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`transition_action`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // transition_id
        $this->transition_id = new DbField('transition_action', 'transition_action', 'x_transition_id', 'transition_id', '`transition_id`', '`transition_id`', 3, 11, -1, false, '`transition_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // action_id
        $this->action_id = new DbField('transition_action', 'transition_action', 'x_action_id', 'action_id', '`action_id`', '`action_id`', 3, 11, -1, false, '`action_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`transition_action`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TransitionActionList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TransitionActionView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TransitionActionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TransitionActionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TransitionActionView";
            case Config("API_ADD_ACTION"):
                return "TransitionActionAdd";
            case Config("API_EDIT_ACTION"):
                return "TransitionActionEdit";
            case Config("API_DELETE_ACTION"):
                return "TransitionActionDelete";
            case Config("API_LIST_ACTION"):
                return "TransitionActionList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TransitionActionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TransitionActionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TransitionActionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TransitionActionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransitionActionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransitionActionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TransitionActionDelete", $this->getUrlParm());
    }
