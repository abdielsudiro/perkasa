...
class ActivityView extends Activity
{
    ...
    // Page object name
    public $PageObjName = "ActivityView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("activity_id") ?? Route("activity_id")) !== null) {
            $this->RecKey["activity_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("activity_id") ?? Route("activity_id")) !== null) {
                ...
                $returnUrl = "ActivityList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ActivityList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ActivityList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
