 ...
 * Page class
 */
class ActivityDelete extends Activity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ActivityDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ActivityList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ActivityList"); // Return to list
                return;
            }
        }
