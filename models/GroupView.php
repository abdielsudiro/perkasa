    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("group_id") ?? Route("group_id")) !== null) {
                ...
                $returnUrl = "GroupList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "GroupList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "GroupList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
