...
class Group extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // group_id
        $this->group_id = new DbField('group', 'group', 'x_group_id', 'group_id', '`group_id`', '`group_id`', 3, 11, -1, false, '`group_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // process_id
        $this->process_id = new DbField('group', 'group', 'x_process_id', 'process_id', '`process_id`', '`process_id`', 3, 11, -1, false, '`process_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('group', 'group', 'x_name', 'name', '`name`', '`name`', 200, 50, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GroupList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GroupView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GroupEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GroupAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GroupView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GroupView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GroupAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GroupAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GroupEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GroupAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GroupDelete", $this->getUrlParm());
    }
