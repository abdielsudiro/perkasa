...
class ActivityEdit extends Activity
{
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_activity_id")) {
            $this->activity_id->setOldValue($CurrentForm->getValue("o_activity_id"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // activity_id
            $this->activity_id->setDbValueDef($rsnew, $this->activity_id->CurrentValue, 0, $this->activity_id->ReadOnly);

            // activity_type_id
            $this->activity_type_id->setDbValueDef($rsnew, $this->activity_type_id->CurrentValue, null, $this->activity_type_id->ReadOnly);
