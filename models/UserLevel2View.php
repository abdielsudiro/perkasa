 ...
 * Page class
 */
class UserLevel2View extends UserLevel2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevel2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("user_level_id") ?? Route("user_level_id")) !== null) {
                ...
                $returnUrl = "UserLevel2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserLevel2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "UserLevel2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
