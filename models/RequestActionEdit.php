 ...
 * Page class
 */
class RequestActionEdit extends RequestAction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestActionEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("request_action_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->request_action_id->setQueryStringValue($keyValue);
                $this->request_action_id->setOldValue($this->request_action_id->QueryStringValue);
            } elseif (Post("request_action_id") !== null) {
                $this->request_action_id->setFormValue(Post("request_action_id"));
                $this->request_action_id->setOldValue($this->request_action_id->FormValue);
            } else {
