 ...
 * Page class
 */
class ProcessPreview extends Process
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "request2") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=request2&" . GetForeignKeyUrl("fk_process_id", $this->process_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "request2") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->process_id->setQueryStringValue($val);
            }
        }
    }
