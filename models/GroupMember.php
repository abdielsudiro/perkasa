...
/**
 * Table class for group_member
 */
class GroupMember extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'group_member';
        $this->TableName = 'group_member';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`group_member`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // group_id
        $this->group_id = new DbField('group_member', 'group_member', 'x_group_id', 'group_id', '`group_id`', '`group_id`', 3, 11, -1, false, '`group_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user_id
        $this->user_id = new DbField('group_member', 'group_member', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, 11, -1, false, '`user_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`group_member`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GroupMemberList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GroupMemberView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GroupMemberEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GroupMemberAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GroupMemberView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GroupMemberView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GroupMemberAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GroupMemberAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GroupMemberEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GroupMemberAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GroupMemberDelete", $this->getUrlParm());
    }
