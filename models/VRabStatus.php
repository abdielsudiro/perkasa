...
/**
 * Table class for v_rab_status
 */
class VRabStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_rab_status';
        $this->TableName = 'v_rab_status';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_rab_status`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // nama_satker
        $this->nama_satker = new DbField('v_rab_status', 'v_rab_status', 'x_nama_satker', 'nama_satker', '`nama_satker`', '`nama_satker`', 200, 70, -1, false, '`nama_satker`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // subtotal
        $this->subtotal = new DbField('v_rab_status', 'v_rab_status', 'x_subtotal', 'subtotal', '`subtotal`', '`subtotal`', 131, 15, -1, false, '`subtotal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_statuses
        $this->id_statuses = new DbField('v_rab_status', 'v_rab_status', 'x_id_statuses', 'id_statuses', '`id_statuses`', '`id_statuses`', 3, 11, -1, false, '`id_statuses`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_rab_status`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VRabStatusList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VRabStatusView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VRabStatusEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VRabStatusAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VRabStatusView";
            case Config("API_ADD_ACTION"):
                return "VRabStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "VRabStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "VRabStatusDelete";
            case Config("API_LIST_ACTION"):
                return "VRabStatusList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRabStatusView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRabStatusView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VRabStatusAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VRabStatusAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VRabStatusEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VRabStatusAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VRabStatusDelete", $this->getUrlParm());
    }
