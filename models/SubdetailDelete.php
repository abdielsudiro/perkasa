 ...
 * Page class
 */
class SubdetailDelete extends Subdetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubdetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SubdetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SubdetailList"); // Return to list
                return;
            }
        }
