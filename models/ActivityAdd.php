 ...
 * Page class
 */
class ActivityAdd extends Activity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ActivityAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ActivityList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ActivityView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // activity_type_id
        $this->activity_type_id->setDbValueDef($rsnew, $this->activity_type_id->CurrentValue, null, false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['activity_id']) == "") {
