 ...
 * Page class
 */
class TransitionAdd extends Transition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransitionAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TransitionView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->next_state_id->CurrentValue = null;
        $this->next_state_id->OldValue = $this->next_state_id->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row['next_state_id'] = $this->next_state_id->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // transition_id
        $this->transition_id->setDbValueDef($rsnew, $this->transition_id->CurrentValue, 0, false);
        ...
        // next_state_id
        $this->next_state_id->setDbValueDef($rsnew, $this->next_state_id->CurrentValue, null, false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['transition_id']) == "") {
