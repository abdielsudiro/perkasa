...
class RoAdd extends Ro
{
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("RoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "RoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "RoView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->nama_ro->CurrentValue = null;
        $this->nama_ro->OldValue = $this->nama_ro->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'nama_ro' first before field var 'x_nama_ro'
        $val = $CurrentForm->hasValue("nama_ro") ? $CurrentForm->getValue("nama_ro") : $CurrentForm->getValue("x_nama_ro");
        if (!$this->nama_ro->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->nama_ro->Visible = false; // Disable update for API request
            } else {
                $this->nama_ro->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->nama_ro->CurrentValue = $this->nama_ro->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['nama_ro'] = $this->nama_ro->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->kode_ro->EditValue = HtmlEncode($this->kode_ro->CurrentValue);
            ...
            $this->nama_ro->EditValue = HtmlEncode($this->nama_ro->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->nama_ro->Required) {
            if (!$this->nama_ro->IsDetailKey && EmptyValue($this->nama_ro->FormValue)) {
                $this->nama_ro->addErrorMessage(str_replace("%s", $this->nama_ro->caption(), $this->nama_ro->RequiredErrorMessage));
            }
        }
        if ($this->id->Required) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nama_ro
        $this->nama_ro->setDbValueDef($rsnew, $this->nama_ro->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RoList"), "", $this->TableVar, true);
