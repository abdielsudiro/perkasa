 ...
 * Page class
 */
class RequestFilePreview extends RequestFile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestFilePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "request2") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=request2&" . GetForeignKeyUrl("fk_request_id", $this->request_id->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "request2") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->request_id->setQueryStringValue($val);
            }
        }
    }
