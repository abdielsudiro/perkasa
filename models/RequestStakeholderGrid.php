 ...
 * Page class
 */
class RequestStakeholderGrid extends RequestStakeholder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestStakeholderGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "frequest_stakeholdergrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'request_stakeholder'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_request2();
