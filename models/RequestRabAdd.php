 ...
 * Page class
 */
class RequestRabAdd extends RequestRab
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestRabAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RequestRabView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->request_rab_id->OldValue = $this->request_rab_id->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['request_rab_id'] = $this->request_rab_id->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'request_rab'
        ...
        // id_rab
        $this->id_rab->setDbValueDef($rsnew, $this->id_rab->CurrentValue, null, false);
