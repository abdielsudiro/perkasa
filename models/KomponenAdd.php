 ...
 * Page class
 */
class KomponenAdd extends Komponen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KomponenAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("KomponenList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "KomponenList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "KomponenView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->nama_komponen->CurrentValue = null;
        $this->nama_komponen->OldValue = $this->nama_komponen->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'nama_komponen' first before field var 'x_nama_komponen'
        $val = $CurrentForm->hasValue("nama_komponen") ? $CurrentForm->getValue("nama_komponen") : $CurrentForm->getValue("x_nama_komponen");
        if (!$this->nama_komponen->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->nama_komponen->Visible = false; // Disable update for API request
            } else {
                $this->nama_komponen->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->nama_komponen->CurrentValue = $this->nama_komponen->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['nama_komponen'] = $this->nama_komponen->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->nama_komponen->EditValue = HtmlEncode($this->nama_komponen->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->nama_komponen->Required) {
            if (!$this->nama_komponen->IsDetailKey && EmptyValue($this->nama_komponen->FormValue)) {
                $this->nama_komponen->addErrorMessage(str_replace("%s", $this->nama_komponen->caption(), $this->nama_komponen->RequiredErrorMessage));
            }
        }
        if ($this->id->Required) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nama_komponen
        $this->nama_komponen->setDbValueDef($rsnew, $this->nama_komponen->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("KomponenList"), "", $this->TableVar, true);
