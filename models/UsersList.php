...
class UsersList extends Users
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->satker->AdvancedSearch->toJson(), ","); // Field satker
    ...
    protected function restoreFilterList()
    {
        ...
        // Field satker
        $this->satker->AdvancedSearch->SearchValue = @$filter["x_satker"];
        $this->satker->AdvancedSearch->SearchOperator = @$filter["z_satker"];
        $this->satker->AdvancedSearch->SearchCondition = @$filter["v_satker"];
        $this->satker->AdvancedSearch->SearchValue2 = @$filter["y_satker"];
        $this->satker->AdvancedSearch->SearchOperator2 = @$filter["w_satker"];
        $this->satker->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->satker, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->satker); // satker
