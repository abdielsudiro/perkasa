 ...
 * Page class
 */
class DetailDelete extends Detail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DetailList"); // Return to list
                return;
            }
        }
