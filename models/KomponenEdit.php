 ...
 * Page class
 */
class KomponenEdit extends Komponen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KomponenEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // nama_komponen
            $this->nama_komponen->setDbValueDef($rsnew, $this->nama_komponen->CurrentValue, null, $this->nama_komponen->ReadOnly);
