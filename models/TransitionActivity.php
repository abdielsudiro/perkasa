...
/**
 * Table class for transition_activity
 */
class TransitionActivity extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'transition_activity';
        $this->TableName = 'transition_activity';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`transition_activity`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // transition_id
        $this->transition_id = new DbField('transition_activity', 'transition_activity', 'x_transition_id', 'transition_id', '`transition_id`', '`transition_id`', 3, 11, -1, false, '`transition_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // activity_id
        $this->activity_id = new DbField('transition_activity', 'transition_activity', 'x_activity_id', 'activity_id', '`activity_id`', '`activity_id`', 3, 11, -1, false, '`activity_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`transition_activity`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TransitionActivityList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TransitionActivityView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TransitionActivityEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TransitionActivityAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TransitionActivityView";
            case Config("API_ADD_ACTION"):
                return "TransitionActivityAdd";
            case Config("API_EDIT_ACTION"):
                return "TransitionActivityEdit";
            case Config("API_DELETE_ACTION"):
                return "TransitionActivityDelete";
            case Config("API_LIST_ACTION"):
                return "TransitionActivityList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TransitionActivityView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TransitionActivityView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TransitionActivityAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TransitionActivityAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransitionActivityEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransitionActivityAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TransitionActivityDelete", $this->getUrlParm());
    }
