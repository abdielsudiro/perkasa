 ...
 * Page class
 */
class RequestActionGrid extends RequestAction
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestActionGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "frequest_actiongrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->request_action_id->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_request_action_id") && $CurrentForm->hasValue("o_request_action_id") && $this->request_action_id->CurrentValue != $this->request_action_id->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_action_id") && $CurrentForm->hasValue("o_action_id") && $this->action_id->CurrentValue != $this->action_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_transition_id") && $CurrentForm->hasValue("o_transition_id") && $this->transition_id->CurrentValue != $this->transition_id->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_is_active") && $CurrentForm->hasValue("o_is_active") && ConvertToBool($this->is_active->CurrentValue) != ConvertToBool($this->is_active->OldValue)) {
            return false;
        }
        if ($CurrentForm->hasValue("x_is_complete") && $CurrentForm->hasValue("o_is_complete") && ConvertToBool($this->is_complete->CurrentValue) != ConvertToBool($this->is_complete->OldValue)) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->request_action_id->clearErrorMessage();
        $this->request_id->clearErrorMessage();
        $this->action_id->clearErrorMessage();
        $this->transition_id->clearErrorMessage();
        $this->is_active->clearErrorMessage();
        $this->is_complete->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_request_action_id")) {
            $this->request_action_id->setOldValue($CurrentForm->getValue("o_request_action_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_action_id")) {
            $this->action_id->setOldValue($CurrentForm->getValue("o_action_id"));
        }
        ...
        if ($CurrentForm->hasValue("o_is_complete")) {
            $this->is_complete->setOldValue($CurrentForm->getValue("o_is_complete"));
        }
    }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // request_action_id
            $this->request_action_id->setDbValueDef($rsnew, $this->request_action_id->CurrentValue, 0, $this->request_action_id->ReadOnly);
            ...
            // transition_id
            $this->transition_id->setDbValueDef($rsnew, $this->transition_id->CurrentValue, null, $this->transition_id->ReadOnly);
            ...
            $this->is_active->setDbValueDef($rsnew, $tmpBool, null, $this->is_active->ReadOnly);
            ...
            $this->is_complete->setDbValueDef($rsnew, $tmpBool, null, $this->is_complete->ReadOnly);
