 ...
 * Page class
 */
class RequestNoteDelete extends RequestNote
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestNoteDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RequestNoteList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RequestNoteList"); // Return to list
                return;
            }
        }
