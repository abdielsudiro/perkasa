...
/**
 * Table class for v_program
 */
class VProgram extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_program';
        $this->TableName = 'v_program';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_program`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Kode
        $this->Kode = new DbField('v_program', 'v_program', 'x_Kode', 'Kode', '`Kode`', '`Kode`', 200, 120, -1, false, '`Kode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Program
        $this->Program = new DbField('v_program', 'v_program', 'x_Program', 'Program', '`Program`', '`Program`', 200, 255, -1, false, '`Program`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Program->Nullable = false; // NOT NULL field
        $this->Program->Required = true; // Required field
        $this->Program->Sortable = true; // Allow sort
        $this->Program->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Program->Param, "CustomMsg");
        $this->Fields['Program'] = &$this->Program;

        // level
        $this->level = new DbField('v_program', 'v_program', 'x_level', 'level', '`level`', '`level`', 20, 2, -1, false, '`level`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_program`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VProgramList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VProgramView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VProgramEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VProgramAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VProgramView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VProgramView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VProgramAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VProgramAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VProgramEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VProgramAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VProgramDelete", $this->getUrlParm());
    }
