...
class UsersEdit extends Users
{
    ...
    protected function newRow()
    {
        $row = [];
        $row['user_id'] = null;
        $row['user_level_permission_id'] = null;
        $row['username'] = null;
        $row['password'] = null;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // user_level_permission_id
            if ($Security->canAdmin()) { // System admin
                $this->user_level_permission_id->setDbValueDef($rsnew, $this->user_level_permission_id->CurrentValue, null, $this->user_level_permission_id->ReadOnly);
            }
            ...
            // satker
            $this->satker->setDbValueDef($rsnew, $this->satker->CurrentValue, null, $this->satker->ReadOnly);
