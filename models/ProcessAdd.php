...
class ProcessAdd extends Process
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProcessView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->process_id->getSessionValue() != "") {
                $this->process_id->CurrentValue = GetForeignKeyValue($this->process_id->getSessionValue());
                $this->process_id->ViewValue = $this->process_id->CurrentValue;
                $this->process_id->ViewValue = FormatNumber($this->process_id->ViewValue, 0, -2, -2, -2);
                $this->process_id->ViewCustomAttributes = "";
            } else {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['process_id']) == "") {
