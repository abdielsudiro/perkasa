...
class Activity extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // activity_id
        $this->activity_id = new DbField('activity', 'activity', 'x_activity_id', 'activity_id', '`activity_id`', '`activity_id`', 3, 11, -1, false, '`activity_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->activity_id->IsPrimaryKey = true; // Primary key field
        $this->activity_id->Nullable = false; // NOT NULL field
        $this->activity_id->Required = true; // Required field
        ...
        // activity_type_id
        $this->activity_type_id = new DbField('activity', 'activity', 'x_activity_type_id', 'activity_type_id', '`activity_type_id`', '`activity_type_id`', 3, 11, -1, false, '`activity_type_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // process_id
        $this->process_id = new DbField('activity', 'activity', 'x_process_id', 'process_id', '`process_id`', '`process_id`', 3, 11, -1, false, '`process_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('activity', 'activity', 'x_name', 'name', '`name`', '`name`', 200, 50, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->name->Sortable = true; // Allow sort
        $this->name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->name->Param, "CustomMsg");
        $this->Fields['name'] = &$this->name;

        // description
        $this->description = new DbField('activity', 'activity', 'x_description', 'description', '`description`', '`description`', 200, 50, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXT');
