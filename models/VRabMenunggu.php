...
/**
 * Table class for v_rab_menunggu
 */
class VRabMenunggu extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_rab_menunggu';
        $this->TableName = 'v_rab_menunggu';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_rab_menunggu`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_rab
        $this->id_rab = new DbField('v_rab_menunggu', 'v_rab_menunggu', 'x_id_rab', 'id_rab', '`id_rab`', '`id_rab`', 3, 11, -1, false, '`id_rab`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_rab_menunggu`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VRabMenungguList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VRabMenungguView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VRabMenungguEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VRabMenungguAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VRabMenungguView";
            case Config("API_ADD_ACTION"):
                return "VRabMenungguAdd";
            case Config("API_EDIT_ACTION"):
                return "VRabMenungguEdit";
            case Config("API_DELETE_ACTION"):
                return "VRabMenungguDelete";
            case Config("API_LIST_ACTION"):
                return "VRabMenungguList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRabMenungguView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRabMenungguView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VRabMenungguAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VRabMenungguAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VRabMenungguEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VRabMenungguAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VRabMenungguDelete", $this->getUrlParm());
    }
