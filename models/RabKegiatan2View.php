 ...
 * Page class
 */
class RabKegiatan2View extends RabKegiatan2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabKegiatan2View";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("rab_kegiatan_id") ?? Route("rab_kegiatan_id")) !== null) {
            $this->RecKey["rab_kegiatan_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("rab_kegiatan_id") ?? Route("rab_kegiatan_id")) !== null) {
                ...
                $this->RecKey["rab_kegiatan_id"] = $this->rab_kegiatan_id->QueryStringValue;
            } elseif (Post("rab_kegiatan_id") !== null) {
                $this->rab_kegiatan_id->setFormValue(Post("rab_kegiatan_id"));
                $this->RecKey["rab_kegiatan_id"] = $this->rab_kegiatan_id->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->rab_kegiatan_id->setQueryStringValue($keyValue);
                $this->RecKey["rab_kegiatan_id"] = $this->rab_kegiatan_id->QueryStringValue;
            } else {
                $returnUrl = "RabKegiatan2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RabKegiatan2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "RabKegiatan2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
