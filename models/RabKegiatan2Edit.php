 ...
 * Page class
 */
class RabKegiatan2Edit extends RabKegiatan2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RabKegiatan2Edit";
    ...
    public function run()
    {
        ...
        $this->rab_kegiatan_id->setVisibility();
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("rab_kegiatan_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->rab_kegiatan_id->setQueryStringValue($keyValue);
                $this->rab_kegiatan_id->setOldValue($this->rab_kegiatan_id->QueryStringValue);
            } elseif (Post("rab_kegiatan_id") !== null) {
                $this->rab_kegiatan_id->setFormValue(Post("rab_kegiatan_id"));
                $this->rab_kegiatan_id->setOldValue($this->rab_kegiatan_id->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->rab_kegiatan_id->IsDetailKey) {
            $this->rab_kegiatan_id->setFormValue($val);
        }
    ...
    {
        global $CurrentForm;
        $this->rab_kegiatan_id->CurrentValue = $this->rab_kegiatan_id->FormValue;
    ...
    protected function validateForm()
    {
        ...
        if ($this->rab_kegiatan_id->Required) {
            if (!$this->rab_kegiatan_id->IsDetailKey && EmptyValue($this->rab_kegiatan_id->FormValue)) {
                $this->rab_kegiatan_id->addErrorMessage(str_replace("%s", $this->rab_kegiatan_id->caption(), $this->rab_kegiatan_id->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // reviewer_note_id
            $this->reviewer_note_id->setDbValueDef($rsnew, $this->reviewer_note_id->CurrentValue, null, $this->reviewer_note_id->ReadOnly);

            // approval_note_id
            $this->approval_note_id->setDbValueDef($rsnew, $this->approval_note_id->CurrentValue, null, $this->approval_note_id->ReadOnly);
