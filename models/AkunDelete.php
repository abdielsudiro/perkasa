...
class AkunDelete extends Akun
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AkunList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AkunList"); // Return to list
                return;
            }
        }
