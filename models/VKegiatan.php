...
/**
 * Table class for v_kegiatan
 */
class VKegiatan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'v_kegiatan';
        $this->TableName = 'v_kegiatan';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`v_kegiatan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Kode
        $this->Kode = new DbField('v_kegiatan', 'v_kegiatan', 'x_Kode', 'Kode', '`Kode`', '`Kode`', 200, 120, -1, false, '`Kode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Kegiatan
        $this->Kegiatan = new DbField('v_kegiatan', 'v_kegiatan', 'x_Kegiatan', 'Kegiatan', '`Kegiatan`', '`Kegiatan`', 200, 255, -1, false, '`Kegiatan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Kegiatan->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Kegiatan->Param, "CustomMsg");
        $this->Fields['Kegiatan'] = &$this->Kegiatan;

        // level
        $this->level = new DbField('v_kegiatan', 'v_kegiatan', 'x_level', 'level', '`level`', '`level`', 20, 2, -1, false, '`level`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_kegiatan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VKegiatanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VKegiatanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VKegiatanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VKegiatanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VKegiatanView";
            case Config("API_ADD_ACTION"):
                return "VKegiatanAdd";
            case Config("API_EDIT_ACTION"):
                return "VKegiatanEdit";
            case Config("API_DELETE_ACTION"):
                return "VKegiatanDelete";
            case Config("API_LIST_ACTION"):
                return "VKegiatanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VKegiatanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VKegiatanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VKegiatanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VKegiatanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VKegiatanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VKegiatanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VKegiatanDelete", $this->getUrlParm());
    }
