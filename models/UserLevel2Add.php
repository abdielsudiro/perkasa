 ...
 * Page class
 */
class UserLevel2Add extends UserLevel2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserLevel2Add";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("UserLevel2List"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "UserLevel2List") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "UserLevel2View") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // user_level_name
        $this->user_level_name->setDbValueDef($rsnew, $this->user_level_name->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("UserLevel2List"), "", $this->TableVar, true);
