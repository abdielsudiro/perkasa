 ...
 * Page class
 */
class RequestStakeholderEdit extends RequestStakeholder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestStakeholderEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("RequestStakeholderList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "RequestStakeholderList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RequestStakeholderList"), "", $this->TableVar, true);
        $pageId = "edit";
