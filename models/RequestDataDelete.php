 ...
 * Page class
 */
class RequestDataDelete extends RequestData
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RequestDataDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RequestDataList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RequestDataList"); // Return to list
                return;
            }
        }
