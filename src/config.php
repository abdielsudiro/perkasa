...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'uWWmaC97ix3FSdHu', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/perkasa2.css", // Project stylesheet file name
    ...
    "USER_LEVEL_FIELD_NAME" => "user_level_permission_id",
